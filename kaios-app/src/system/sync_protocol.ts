export enum SyncProtocol {
  STREAM_UP                   = "SYNC_STREAM_UP",
  STREAM_DOWN                 = "SYNC_STREAM_DOWN",
  PING                        = "PING",
  PONG                        = "PONG",
  ...
  SYNC_CONTACT_KAIOS_CARDDAV  = "SYNC_CONTACT_KAIOS_CARDDAV",
  SYNC_CONTACT_CARDDAV_KAIOS  = "SYNC_CONTACT_CARDDAV_KAIOS",
}
